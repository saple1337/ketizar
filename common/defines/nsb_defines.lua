...
--NDefines.NBuildings.SUPPLY_PORT_LEVEL_THROUGHPUT = 8   -- vanilla 3; unused in 1.11 NSB? -- supply throughput per level of naval base
...
NDefines.NSupply.DAYS_TO_START_GIVING_FULL_SUPPLY_AFTER_MOVING_SUPPLY_CAPITAL = 0
...
NDefines.NMilitary.COMBAT_SUPPLY_LACK_DEFENDER_DEFEND = -0.28     -- defend combat penalty for defender if out of supply
