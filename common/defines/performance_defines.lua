...
NDefines.NAI.DEPLOY_MIN_TRAINING_SURRENDER_FACTOR = 0.99
NDefines.NAI.DEPLOY_MIN_EQUIPMENT_SURRENDER_FACTOR = 0.99
NDefines.NAI.DEPLOY_MIN_TRAINING_PEACE_FACTOR = 0.99
NDefines.NAI.DEPLOY_MIN_EQUIPMENT_PEACE_FACTOR = 0.99
NDefines.NAI.DEPLOY_MIN_TRAINING_WAR_FACTOR = 0.99
NDefines.NAI.DEPLOY_MIN_EQUIPMENT_WAR_FACTOR = 0.99
NDefines.NAI.DYNAMIC_STRATEGIES_THREAT_FACTOR = 4
...
NDefines.NAI.FOCUS_TREE_CONTINUE_FACTOR = 1.5
...
NDefines.NAI.AT_WAR_THREAT_FACTOR = 2.0
NDefines.NAI.NEIGHBOUR_WAR_THREAT_FACTOR = 1.10 
NDefines.NAI.POTENTIAL_ALLY_JOIN_WAR_FACTOR = 0
NDefines.NAI.POTENTIAL_FUTURE_ENEMY_FACTOR = 0
NDefines.NAI.NEUTRAL_THREAT_PARANOIA = 10
NDefines.NAI.DIFFERENT_FACTION_THREAT = 30
...
NDefines.NAI.WANTED_UNITS_INDUSTRY_FACTORY = 1.60                       -- How many units a country wants is partially based on how much military industry that is available
NDefines.NAI.WANTED_UNITS_THREAT_MAX = 6.0                           -- Normalized threat is clamped to this
NDefines.NAI.WANTED_UNITS_WAR_THREAT_FACTOR = 1.15                     -- Factor threat with this if country are fascist, communist or at war
NDefines.NAI.WANTED_UNITS_MILFACTORY_MIN = 1                        -- Military factory factor is min-clamped to this
NDefines.NAI.WANTED_UNITS_MANPOWER_MIN = 1                         -- Manpower factor is min-clamped to this
NDefines.NAI.WANTED_UNITS_DANGEROUS_NEIGHBOR_FACTOR = 1.1              -- Factor if has dangerous neighbor
NDefines.NAI.WANTED_UNITS_MANPOWER_DIVISOR = 21000                     -- Normalizing divisor for AI manpower. (below this they will be careful making more divisions, above they want more)
...
NDefines.NAI.AI_UPDATE_ROLES_FREQUENCY_HOURS = 100              -- Update the roles for a country AI this often (affects performance)
NDefines.NAI.UPDATE_SUPPLY_MOTORIZATION_FREQUENCY_HOURS = 100     -- Check if activating motorization would improve supply situation this often.
NDefines.NAI.UPDATE_SUPPLY_BOTTLENECKS_FREQUENCY_HOURS = 100     -- Check for and try to fix supply bottlenecks this often. (168 hours = 1 week)
