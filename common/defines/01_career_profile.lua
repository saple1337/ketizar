...
NCareerProfile = {
	-- Mod defines
	MOD_STATISTICS_GROUP = "TzarMod", -- Can be set by mods to collect statistics in a separate data set for the mod. Will also be used as the display name if MOD_STATISTICS_GROUP_NAME is not set.
	MOD_STATISTICS_GROUP_NAME = "TzarMod", -- Can be set by mods as a display name for the mod's statistics data set. It can be a localized.
	...
	STEEL_AT_HIGH_SPEED_RIBBON_TANK_SPEED = 12, -- Minimum speed to count deployed tanks for Steel at High Speed Ribbon
		...
		NEVERMINE_ME_MEDAL_MIN_RATIO = 0.5, -- Minimum effect mines should have on the dominance to count current naval region for Nevermine Me Medal
